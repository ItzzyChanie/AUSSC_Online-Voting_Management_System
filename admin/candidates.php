      ...
      <h1><b>
          ...
          <div style="display: flex; align-items: center; margin-top: 23px;">
            ...
            style="margin-right: 20px; 
                  ...
                  color: black; 
                  font-size: 18px; 
                  font-family: 'Poppins', sans-serif;">CANDIDATES LIST</span>
            ...
            <ol class="breadcrumb" 
              ...
              <li style="font-weight: normal;"><a href="home.php"><i class="fa fa-dashboard" ></i> Home</a></li>
              <li class="active" 
                  style="color: black; 
                  font-size: 17px; 
                  font-family: 'Poppins', sans-serif; 
                  font-weight: normal;" >Dashboard</li>
            </ol>
          </div>
     </b> </h1>
    </section>
                        ...
                        <tr style='color:black ; font-size: 15px; font-family: Poppins, sans-serif;'>
                          ...
                          <td>
                            <button class='btn btn-success btn-sm edit btn-curve enhanced-edit-btn' 
                                    ...
                                    box-shadow: none; 
                                    transition: background 0.2s, color 0.2s;
                                    ' data-id='".$row['canid']."' ><i class='fa fa-edit'></i> Edit</button>
                            ...
                            <button class='btn btn-danger btn-sm delete btn-curve enhanced-delete-btn' 
                                    ...
                                    box-shadow: none; 
                                    transition: background 0.2s, color 0.2s;
                                    ' data-id='".$row['canid']."'><i class='fa fa-trash'></i> Delete</button>
                          <style>
