...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color:#fff; font-family: 'Poppins', sans-serif; margin-top: 20px;">
    ...
    style="position: relative; 
      ...
      style="margin-right: 20px; 
            ...
            color: black; 
            font-size: 18px; 
            font-family: 'Poppins';">PARTY LISTS</span>
          ...
          <div class="box" style="background-color: #c4c9cec2; position: relative; top: 3px">
            <div class="box-header with-border" style="background-color: #b9b7b7c8">
              <a href="#add" 
                ...
                style="background-color: #4682B4; color: black; font-size: 12px; font-family: 'Poppins', sans-serif;">
                        ...
                        <tr style='color:black ; font-size: 15px; font-family:Times'>
                          ...
                          <td>
                            <button class='btn btn-success btn-sm edit btn-curve enhanced-edit-btn' 
                                    style='background: #198754; color: #fff; font-size: 13px; font-family: Poppins, sans-serif; border: none; border-radius: 6px; padding: 6px 18px; box-shadow: none; transition: background 0.2s, color 0.2s;' data-id='".$row['id']."'>
                                    <i class='fa fa-edit'></i> Edit</button>
                            <button class='btn btn-danger btn-sm delete btn-curve enhanced-delete-btn' 
                                    style='background: #dc3545; color: #fff; font-size: 13px; font-family: Poppins, sans-serif; border: none; border-radius: 6px; padding: 6px 18px; box-shadow: none; transition: background 0.2s, color 0.2s;' data-id='".$row['id']."'>
